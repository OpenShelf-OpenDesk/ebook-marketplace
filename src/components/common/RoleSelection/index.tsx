          ...
          <div className="group flex flex-col card border border-gray-200 shadow-lg">
            <div className="flex h-64 justify-center relative">
              <Image
                ...
                layout="fill"
                className="scale-95 transition duration-500 ease-in-out transform group-hover:-translate-y-1 group-hover:scale-90"
              />
            </div>
          ...
          <div className="group flex flex-col card border border-gray-200 shadow-lg">
            <div className="flex h-64 justify-center relative">
              <Image
                ...
                layout="fill"
                className="transition duration-500 ease-in-out transform group-hover:-translate-y-1 group-hover:scale-90"
              />
            </div>
            <div className="card-body text-gray-700">
